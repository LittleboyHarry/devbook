...
<LogoCard name="开发者环境" to="dev/scoop" logo={ <img src="https://cdn.jsdelivr.net/gh/microsoft/vscode-icons@main/icons/light/package.svg"  width="100%" /> }/>
<LogoCard name="Scoop" to="dev/getstarted" logo={ <img src="https://cdn.jsdelivr.net/gh/microsoft/vscode-icons@main/icons/light/package.svg"  width="100%" /> }/>
